...
<?php if(!$adminConfig['hide_twitter_feed']){ ?>
		...
		<div class="col-md-4" id="twitter-feed">
			<h3>
				<?php echo $Translation["BigProf "]; ?>
				<span class="pull-right">
					<a class="twitter-follow-button" href="https://www.configuroweb.com/" data-show-count="false" data-lang="en"><?php echo $Translation["ConfiguroWeb"]; ?></a>
					<script type="text/javascript">
						window.twttr = (function (d, s, id) {
							var t, js, fjs = d.getElementsByTagName(s)[0];
							if (d.getElementById(id)) return;
							js = d.createElement(s); js.id = id;
							js.src= "https://platform.twitter.com/widgets.j";
			...
			<div class="text-center">
				<a class="twitter-timeline" height="400" href="https://www.configuroweb.com/" data-widget-id="552758720300843008" data-chrome="nofooter noheader"><?php echo $Translation["loading bigprof feed"]; ?></a>
