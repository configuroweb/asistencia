<?php
	...
	*/
	...
	$schema = array(   
		'students' => array(   
			'regno' => array('appgini' => 'VARCHAR(40) not null primary key '),
			'name' => array('appgini' => 'VARCHAR(100) not null '),
			'course' => array('appgini' => 'INT unsigned ')
		),
		'units' => array(   
		...
		'attendance' => array(   
			'student' => array('appgini' => 'VARCHAR(40) '),
			'regno' => array('appgini' => 'VARCHAR(40) '),
			'week' => array('appgini' => 'VARCHAR(40) '),
